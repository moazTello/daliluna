...
const useClassifiedsDepartments =  () => {
    ...
    const getClassifiedsDepartments = async (departmentId) => {
        try{
            setLoading(true);
            // const res = await axiosPrivateTokenized.get("/dashboard/classifieds/${classifiedId}/classified-departments",{
            const res = await axiosPrivateTokenized.get(`/dashboard/classifieds/${departmentId}/classified-departments`,{

...
const EditFieldClassDepartment = () => {
  ...
  const { loadingEditingField, editDepartmentField, getEditDepartmentField } =
    useEditDepartmentField();
  useEffect(() => {
    const getEdit = async () => {
    ...
    <div className="flex flex-col items-center justify-center w-11/12 mx-auto">
      ...
      >
        <h1 className="text-base font-semibold text-start mt-5 text-gray-200">
          EDIT FIELD DEPARTMENT FIELD <span className="text-red-600"> NOT WORKING CAUSE OF API INDEX</span>
        </h1>

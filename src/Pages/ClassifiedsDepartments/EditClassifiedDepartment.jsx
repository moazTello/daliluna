...
const EditClassifiedDepartment = ({item}) => {
    const {classifiedid, classifiedDepartmentId} = useParams();
    const { 
        loading, editClassifiedDepartment, getEditClassifiedDepartment ,editedname, setEditedName
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await editClassifiedDepartment({name:editedname},classifiedid,classifiedDepartmentId);

...
import useAddClassified from "../../../hooks/Classifieds/useAddClassified";
...
const AddClassified = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await addClassified({ name: name, icon: icon });
      ...
      backdrop-filter backdrop-blur-lg bg-opacity-0 ">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <label
              htmlFor="choose"
              className="w-full bg-base-100 rounded-md flex items-center justify-start pl-5 
              input-bordered h-10 my-5 cursor-pointer text-white"
            >
              Insert An Image
            </label>
            <input
